...
from contract.views.enem_view import enem_upload_view, EnemDataListView
...
from contract.views.merito_academico_view import merito_academico_input, MeritoAcademicoListView
...
urlpatterns = [
    ...
    path('api/enem-data/', EnemDataListView.as_view(), name='enem-data-list'),
    path('api/merito-academico/', MeritoAcademicoListView.as_view(), name='merito-academico-list'),
